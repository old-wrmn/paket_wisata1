...
//DATA restaurant
$query = "SELECT restaurant.id_restaurant, restaurant.name, restaurant.address, restaurant.open, restaurant.close,  restaurant.description, st_x(st_centroid(restaurant.geom)) as lon, st_y(st_centroid(restaurant.geom)) as lat from restaurant where restaurant.id_restaurant ='$id'";
...
<?php
			...
			$xx = 0;
	     	while($baris = mysqli_fetch_array($hasil)){
     			$nilai=$baris['gallery_restaurant'];
     			$xx++;
	 	?>			
...
<a href="?page=formUpdateRest&id=<?php echo $id ?>" class="btn btn-round btn-warning mb-2"><i class="icon-pencil7 mr-1"></i>Update Data</a>
...
<div id="modal_theme_info" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form role="form" action="act/saveImgRest.php" enctype="multipart/form-data" method="post">
