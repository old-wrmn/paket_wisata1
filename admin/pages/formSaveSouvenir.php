            ...
            <div id="modal_form_horizontal" class="modal fade" tabindex="-1">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <form name="form_input" action="act/saveSouvenir.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <?php
                      include '../connect.php';
                          $query = mysqli_query($conn,"SELECT MAX(id_souvenir) AS id FROM souvenir");
