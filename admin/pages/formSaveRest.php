            ...
            <div id="modal_form_horizontal" class="modal fade" tabindex="-1">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <form name="form_input" action="act/saveRest.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <?php
                      include '../connect.php';
                          $query = mysqli_query($conn,"SELECT MAX(id_restaurant) AS id FROM restaurant");
                    ...
                    <div class="modal-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea type="text" id="geom" name="geom" class="form-control"></textarea>
                        </div>
                      </div>
