            ...
            <div id="modal_form_horizontal" class="modal fade" tabindex="-1">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <form name="form_update" action="act/saveUpdateWorship.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <?php
                      include '../connect.php';
                          if (isset($_GET['id']))
                            {
                              ...
                              $sql = mysqli_query($conn,"SELECT 
                                  worship_place.id_worship_place, 
                                  worship_place.name as nama, 
                                  worship_place.address, 
                                  worship_place.description, 
