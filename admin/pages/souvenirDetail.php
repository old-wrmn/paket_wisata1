...
<a href="?page=formUpdateSouvenir&id=<?php echo $id ?>" class="btn btn-round btn-warning mb-2"><i class="icon-pencil7 mr-1"></i>Update Data</a>
...
<div id="modal_theme_info" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form role="form" action="act/saveImgSouvenir.php" enctype="multipart/form-data" method="post">
