...
//DATA worship_place
$query = "SELECT worship_place.id_worship_place, worship_place.name, worship_place.address, worship_place.description, st_x(st_centroid(worship_place.geom)) as lon, st_y(st_centroid(worship_place.geom)) as lat from worship_place where worship_place.id_worship_place ='$id'";
...
<div class="card col-md-4" id="galleryrecommendxxx">
	<div class="slider" id="gallery1">
		<div class="isi-slider">
		  <?php
			$id=$_GET['id'];
			$querysearch="SELECT gallery_worship_place FROM worship_place_gallery where id_worship_place='$id'";
			$hasil=mysqli_query($conn, $querysearch);			 
			$xx = 0;
	     	while($baris = mysqli_fetch_array($hasil)){
     			$nilai=$baris['gallery_worship_place'];
     			$xx++;
	 	?>			
...
<a href="?page=formUpdateWorship&id=<?php echo $id ?>" class="btn btn-round btn-warning mb-2"><i class="icon-pencil7 mr-1"></i>Update Data</a>
...
<div id="modal_theme_info" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form role="form" action="act/saveImgWorship.php" enctype="multipart/form-data" method="post">
