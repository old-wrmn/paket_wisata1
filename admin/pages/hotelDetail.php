...
//DATA hotel
$query = "SELECT hotel.id_hotel, hotel.name, hotel.address, hotel.contact, st_x(st_centroid(hotel.geom)) as lon, st_y(st_centroid(hotel.geom)) as lat from hotel where hotel.id_hotel ='$id'";
...
<div id="modal_theme_info" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form role="form" action="act/saveImgHotel.php" enctype="multipart/form-data" method="post">
