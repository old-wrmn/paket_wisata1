...
function initialize(){
  ...
  //menampilkan digitasi untuk update data tourism
  tourism_dig = new google.maps.Data();
  tourism_dig.loadGeoJson('act/tourism.php?id='+id.value);
  tourism_dig.setMap(map);
  tourism_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });

  //menampilkan digitasi untuk update data hotel
  tourism_dig = new google.maps.Data();
  tourism_dig.loadGeoJson('act/hotel.php?id='+id.value);
  tourism_dig.setMap(map);
  tourism_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  //menampilkan digitasi untuk update data restaurant
  tourism_dig = new google.maps.Data();
  tourism_dig.loadGeoJson('act/restaurant.php?id='+id.value);
  tourism_dig.setMap(map);
  tourism_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  //menampilkan digitasi untuk update data worship
  tourism_dig = new google.maps.Data();
  tourism_dig.loadGeoJson('act/worship.php?id='+id.value);
  tourism_dig.setMap(map);
  tourism_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  //menampilkan digitasi untuk update data worship
  tourism_dig = new google.maps.Data();
  tourism_dig.loadGeoJson('act/souvenir.php?id='+id.value);
  tourism_dig.setMap(map);
  tourism_dig.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  tourism_dig.addListener('addfeature', function(e) {
