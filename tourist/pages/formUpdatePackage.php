...
<div class="card col-xl-12">  
      ...
      <div class="card-body">
        ...
        <?php 
          $selesai = mysqli_query($conn, "SELECT COUNT(id_worship_place) as msq from object_point where id_package='$id'");
          $baris = mysqli_fetch_array($selesai);
          $msq = $baris['msq'];
          if ($msq==0) {
        ?>
        <button type="button" class="btn bg-danger-400 text-danger-400 border-danger-400 mt-1 mb-3 col-xl-12" data-toggle="modal" data-target="#modal_theme_danger">SELESAI</button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn bg-danger" onclick="delPackage('<?php echo $id ?>')">Discard Package</button>
              </div>
            </div>
          </div>
        </div>
