        var map;
        var server = ipServerTourism; //"http://localhost/pdg_tourism/tourism_pdg/";
        ...
        function basemap(){   // CENTER POSITION GOOGLE MAP
        ...
        function kecamatanTampil(){   // PENAMPILAN PEMBAGIAN KECAMATAN DI PADANG
        ...
        {
          $('#tombol').empty();
          $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-default " data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 5px; background: #26a69a ;color:white;"><i class="icon-eye-blocked style="margin-right: 5px; background: #26a69a;  color:white ;"></i></a> ');
          ...
          var layer = new google.maps.FusionTablesLayer(
            ...
            var legend = document.createElement('div');
                ...
                content.push('<p><div class="color a"></div>District of Lubuk Kilangan</p>');
                content.push('<p><div class="color b"></div>District of Pauh</p>');
                content.push('<p><div class="color c"></div>District of Padang Selatan</p>');
                content.push('<p><div class="color d"></div>District of Lubuk Begalung</p>');
                content.push('<p><div class="color e"></div>District of Padang Timur</p>');
                content.push('<p><div class="color f"></div>District of Kuranji</p>');
                content.push('<p><div class="color g"></div>District of Nanggalo</p>');
                content.push('<p><div class="color h"></div>District of Padag Barat</p>');
                content.push('<p><div class="color i"></div>District of Padang Utara</p>');
                content.push('<p><div class="color j"></div>District of Bungus Teluk Kabung</p>');
                content.push('<p><div class="color j"></div>District of Koto Tangah</p>');                
        ...
        function hideLegenda() {
          ...
          $('#tombol').empty();
          console.log("Success");
          $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-default " data-toggle="tooltip" title="Legenda" style="margin-right: 5px; background:#26a69a ; color:white;"><i class="icon-eye" style="color:white;"> </i></a>');
        }
...
// GALLERY RECOMMENDATION SLIDER KLIK
...
function geolocation(){
      ...
      function tampilDigitTourism()
      {
        digit = new google.maps.Data();
        digit.loadGeoJson(server+'act/digitasiTourism.php');
              ...
              url: server+'act/lihatsemua.php?id='+aab, data: "", dataType: 'json', success: function(rows)
                ...
                for (var i in rows) 
                  ...
                  console.log(name);
                   ...
                   $('#kanan_table').append("<tr><td>"+name+"</td><td>Rp "+price+"</td><td><a role='button' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-road' title='route' onclick='rute(\""+id+"\");tampilanobjek(\""+id+"\");'></a></td><td><a role='button' class='btn btn-outline bg-green-400 text-green-400 border-green-400 icon-envelop5' title='booking' href='#modalbooking' data-toggle='modal' onclick='booking(\""+id+"\",\""+price+"\")'></a></td><td><a role='button' title='Package Info' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-info22' value='Route' onclick='gallery(\""+id+"\")'></a></td><td><a role='button' title='List Package' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-list-unordered' value='Detail' onclick='showdetpackage(\""+id+"\")'></a></td><td><a role='button' title='Gallery' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-play' value='Route' onclick='videopaket(\""+id+"\")'></a></td></tr>");
      ...
      function data_tourism_1_info(ids){ // DATA 1 TOURISM
        ...
        $.ajax({url: server+'tourist/act/_dataTourism.php?cari='+ids, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows.data){ 
            ...
            marker = new google.maps.Marker({
             icon: server+'global_assets/icon/marker_tw.png',
              position : pos,
              map: map,
              animation: google.maps.Animation.DROP,
              });
            marker.info = new google.maps.InfoWindow({
                content: "<span style=color:black><center><b>"+name+"</b></center><br><i class='icon-pin-alt' style='padding: 5px'></i>"+address+"<br><i class='icon-ticket' style='padding: 5px'></i>"+"Rp "+ticket+"<br><br>&nbsp &nbsp &nbsp<a class='btn btn-default icon-road' style='background: #26a69a; color: white;' role=button' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+rad_lat+"\",\""+rad_lng+"\")' title='route' aria-controls='Route' id='btn_angkot'></a>&nbsp &nbsp &nbsp <a class='btn btn-default icon-info22' style='background: #26a69a; color: white;' role=button' onclick='galeri(\""+ids+"\")' title='Info' aria-controls='Info' id='btn_gallery'></a></label>&nbsp &nbsp &nbsp<a class='btn btn-default icon-compass4' style='background: #26a69a; color: white;' role=button' onclick='cekNearBy()' title='Nearby' aria-controls='Nearby' id='btn_angkot'></a></span>",
                pixelOffset: new google.maps.Size(0, -1)
                  });
            marker.info.open(map, marker);
          ...
          // Tombol Angkot
          $('#label_angkot').empty();
          $('#label_angkot').append("<a class='btn btn-default' role='button' data-toggle='collapse'  onclick='angkot_sekitar(\""+ids+"\")' title='Nearby' aria-controls='Nearby' id='btn_angkot'><i class='icon-compass4' style='color:black;''></i><label>&nbsp Angkot</label></a>")

          // Tombol Gllaery
          $('#label_gallery').empty();
          $('#label_gallery').append("<a class='btn btn-default' role='button' data-toggle='collapse'  onclick='galeri(\""+ids+"\")' title='Nearby' aria-controls='Nearby' id='btn_gallery'><i class='icon-compass4' style='color:black;''></i><label>&nbsp Gallery</label></a>")
      ...
      function cekNearBy(){
          ...
          var stringHTML = "<tr colspan='4'><td colspan='3'><div class='checkbox'><label style='float:left'><input id='check_tw' type='checkbox'>Tourism</label></div></td><td colspan='3'><div class='checkbox'><label style='float:left'><input id='check_i' type='checkbox'>Small Industry</label></div></td></tr><tr colspan='4'><td colspan='3'><div class='checkbox'><label style='float:left'><input id='check_oo' type='checkbox' value=''> Souvenir </label></div></td><td colspan='3'><div class='checkbox'><label style='float:left'> <input id='check_m' type='checkbox' value=''>Worship</label></div></td></tr><tr><td colspan='3'><div class='checkbox'><label style='float:left'><input id='check_k' type='checkbox' value=''>Culinary</label></div></td><td colspan='3'><div class='checkbox'><label style='float:left'><input id='check_h' type='checkbox' value='5'>Hotel</label></div></td></tr><tr><td colspan='4'><div class='checkbox'><label style='float:left'><input id='check_r' type='checkbox' value=''>Restaurant</label></div></td></tr><tr><td colspan='4' style='text-align: center'><input id='inputradius2' type='range' onchange='aktifkanRadius()' name='inputradius' data-highlight='true' min='1' max='10' value='1'><div id='angkot_sekitar' class='centered'></div></td></tr>";
...
// GALLERY RECOMMENDATION
        function gallery(){
          hapus_menu();
          $('#view_kanan_table').show();
          document.getElementById('judul_table').innerHTML="Recommendation List";

          $('#kanan_table').empty();
          $('#kanan_table').append("<tr><th class='centered'>Name</th><th class='centered'></th></tr>");
          $.ajax({ 
          url: server+'primary_tourism.php', data: "", dataType: 'json', success: function(rows) 
          { 
              for (var i in rows){ 
                var row = rows[i];
                var id = row.id;
                ...
                $('#kanan_table').append("<tr><td>"+name+"</td><td></td></tr>");  
...
// DASHBOARD
        ...
        function gallery2(){
          ...
          $('#view_kanan_table').hide();
          document.getElementById('judul_table').innerHTML="Tourism Recommendation";

          $('#galleryrecommendxxx').show();

          // $('#kanan_table').empty();
          // $('#kanan_table').append("<tr><th class='centered'>Name</a></th></tr>");
          $.ajax({ 
          url: server+'primary_tourism.php', data: "", dataType: 'json', success: function(rows) 
          { 
              for (var i in rows){ 
                ...
                var latitude=row.lat;
                var longitude = row.lng;
                $('#kanan_table').append("<tr><td>"+name+"</td><td  style='padding: 5px'><a role='button' class='btn btn-primary icon-info3' style='color: white' title='info' onclick='data_tourism_1_info(\""+id+"\")'></a></td><td style='padding: 5px'><a role='button' class='btn btn-danger icon-car2' style='color: white' title='Angkot' onclick='angkot_sekitar(\""+id+"\")'></a></td></tr>");  
...
// LIST TOURISM
        ...
        function listTourism(){ // Menu Tourism
          ...
          $('#kanan_table').empty();
          $('#kanan_table').append("<tr><th class='centered'>Name</th><th class='centered; text-center' colspan='3'>Action</th></tr>");
          $.ajax({ 
          url: server+'tourist/act/_listPackage.php', data: "", dataType: 'json', success: function(rows) 
          { 
              for (var i in rows){ 
                var row = rows[i];
                var id = row.id;
      ...
      *********************************************************************************************************************************************************** */
      ...
      function tw_sekitar_user(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR USER
          ...
          $.ajax({url: server+'tourist/act/_sekitarTourism.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            if(rows == null)
            {
              console.log("xxx");
            ...
            for (var i in rows){ 
              ...
              klikInfoWindow(id,marker);
              map.setCenter(centerBaru);
              document.getElementById('judul_table').innerHTML="Tourism Arround You";
              $('#kanan_table').append("<tr><td>"+name+"</td><td style='padding: 5px'><a role='button' class='btn btn-primary icon-info3' style='color: white' title='info' onclick='data_tourism_1_info(\""+id+"\")'></a></td><td style='padding: 5px'><a role='button' class='btn btn-danger icon-car2' style='color: white' title='Angkot' onclick='angkot_sekitar(\""+id+"\")'></a></td></tr>"); 
            }//end for
          }});//end ajax  
      ...
      *********************************************************************************************************************************************************** */
              ...
              url: server+'act/cariPaket.php?name='+car, data: "", dataType: 'json', success: function(rows)
                ...
                {   
                  ...
                  console.log(name);
                   ...
                   $('#kanan_table').append("<tr><td>"+name+"</td><td>Rp "+price+"</td><td><a role='button' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-road' title='route' onclick='rute(\""+id+"\");tampilanobjek(\""+id+"\");'></a></td><td><a role='button' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-envelop5' title='booking' href='#modalbooking' data-toggle='modal' onclick='booking(\""+id+"\",\""+price+"\")'></a></td><td><a role='button' title='Package Info' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-file-picture2' value='Route' onclick='gallery(\""+id+"\")'></a></td><td><a role='button' title='List Package' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-info22' value='Detail' onclick='showdetpackage(\""+id+"\")'></a></td><td><a role='button' title='Gallery' class='btn btn-outline bg-blue-400 text-blue-400 border-blue-400 icon-play' value='Route' onclick='videopaket(\""+id+"\")'></a></td></tr>");
      ...
      function cariDestinasi(){
        ...
        {
            console.log(server+'act/cariDestinasi.php?status='+objek+'&id='+cariobjek);
          $.ajax({ 
              url: server+'act/cariDestinasi.php?status='+objek+'&id='+cariobjek, data: "", dataType: 'json', success: function(rows)
                { 
                  if(rows==null)
                  {
                    alert('There is No Package');
      ...
      function cari_tourism(tipe){ // PENCARIAN ANGKUTAN KOTA
          ...
          if (tipe == 1) {
            ...
            document.getElementById('judul_table').innerHTML="Search tourism by district";
            y = document.getElementById('select_district').value;   
          }

          if (y == "") {          
            document.getElementById('modal_title').innerHTML="Info";
            document.getElementById('modal_body').innerHTML="Please fill in the form first";
            $('#myModal').modal('show'); 
            return;
          } else {
            $("#view_kanan_table").show();
          ...
          $.ajax({url: server+'_data_tourism_cari.php?tipe='+tipe+'&nilai='+y, data: "", dataType: 'json', success: function(rows){ 
            if(rows == null)
            {
              ...
              for (var i in rows){ 
                ...
                var lng = row.lng;
                var lat = row.lat;
                $('#kanan_table').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' onclick='data_tourism_1_info(\""+id+"\")'>&nbsp&nbsp&nbspInfo</a><a role='button' style='margin:5px' class='btn btn-default' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+lat+"\",\""+lng+"\")'>Route</a></td></tr>");  
      ...
      function td_hotel_angkot(id_angkot){ // HOTEL SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_hotel.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            map.setCenter(centerBaru);
            $('#table_kanan_hotel').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px' onclick='modal_hotel(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+id_angkot+"\",\""+id+"\")'>Route</a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function td_kuliner_angkot(id_angkot){ //KULINER SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_culinary_place.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            $('#table_kanan_culinary').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px'  onclick='modal_kuliner(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'>Route</a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function td_masjid_angkot(id_angkot){ // MASJID SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_worship_place.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_worship').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px'  onclick='modal_masjid(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'>Route</a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      function td_oo_Angkot(id_angkot){ // OLEH-OLEH SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_souvenir.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_souvenir').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px'  onclick='modal_oo(\""+id+"\") '></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'>Lihat</a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      function td_tw_angkot(id_angkot){ // TOURISM SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_tourism.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_tourism').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px'  onclick='modal_tw(\""+id+"\") '></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'>Route</a></td></tr>");
            }//end for
        }});//end ajax  
      }
      ...
      // TEMPAT WISATA SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_restaurant.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_restaurant').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-default icon-info22' style='margin-right:10px' onclick='modal_restaurant(\""+id+"\") '></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\""+id+"\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'>Route</a></td></tr>");
            }//end for
        }});//end ajax  
      }
